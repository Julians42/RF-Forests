...
other <- read_csv(here("data/all_sim_results_with_rf.csv"))
rf30 <- read_csv(here("data/merf01_sim_results_30_2000.csv"))
rf50 <- read_csv(here("data/merf01_sim_results_50_2000.csv"))
rf100 <- read_csv(here("data/merf01_sim_results_100_2000.csv"))
rf30$...1 <- NULL
rf50$...1 <- NULL
rf100$...1 <- NULL
rf30$sample_size = 30
rf50$sample_size = 50
rf100$sample_size = 100
...
full_res %>% write.csv(here("data/all_sim_results_with_merf.csv"))


# load data
full_res <- read_csv(here("~/Documents/Research/Thesis/RF-Forests/data/all_sim_results_with_merf.csv"))
