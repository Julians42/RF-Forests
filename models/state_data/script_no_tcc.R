...
ps_results %>% write.csv("~/Documents/Research/Thesis/RF-Forests/models/state_data/ps_res_ntcc.csv")
######################## get section means ##########################
...
aeblup_results %>% write.csv("~/Documents/Research/Thesis/RF-Forests/models/state_data/aeblup_results_ntcc.csv")
########################### Unit-EBLUP ################################
...
ueblup_res %>% write.csv("~/Documents/Research/Thesis/RF-Forests/models/state_data/ueblup_res_ntcc.csv")
...
uzi_res %>% write.csv("~/Documents/Research/Thesis/RF-Forests/models/state_data/uzi_res_ntcc.csv")
...
rf_res %>% write.csv("~/Documents/Research/Thesis/RF-Forests/models/state_data/rf_res_ntcc.csv")
...
smerf_res %>% write.csv("~/Documents/Research/Thesis/RF-Forests/models/state_data/smerf_res_ntcc.csv")


all_results = list(ps_results, rf_res, smerf_res, aeblup_results, ueblup_res, uzi_res) %>% reduce(full_join)

all_results %>% write.csv("~/Documents/Research/Thesis/RF-Forests/models/state_data/results2000_ntcc.csv")